...
private:
    inline static const UCHAR bitOffsetArray[8]{
        0b00000001,
        0b00000010,
        0b00000100,
        0b00001000,
    ...
    inline static const UCHAR bitOffsetReversedArray[8]{
        0b11111110,
        0b11111101,
        0b11111011,
        0b11110111,
...
public:
    ...
    inline void Reset(bool target) {
        ...
        memset(ptr, target ? 1 : 0, sizeof(UCHAR) * capa);
    }
